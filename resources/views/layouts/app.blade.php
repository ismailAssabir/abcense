...
<body class="h-full text-slate-800">
    ...
    <div class="min-h-full flex flex-col">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('logout') }}" class="bg-slate-800 hover:bg-red-600 transition-all duration-200 px-3 py-1.5 rounded-lg text-sm font-semibold flex items-center gap-1.5">
        ...
        <main class="flex-grow py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
            <!-- Messages Flash -->
            @if (session('success'))
                <div class="mb-6 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 flex items-center gap-3 shadow-sm transition-all duration-300">
            ...
            @if (session('error'))
                <div class="mb-6 p-4 rounded-xl bg-rose-50 border border-rose-200 text-rose-800 flex items-center gap-3 shadow-sm transition-all duration-300">
            ...
            @if ($errors->any())
                <div class="mb-6 p-4 rounded-xl bg-rose-50 border border-rose-200 text-rose-800 shadow-sm transition-all duration-300">
